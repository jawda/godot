...
func generate(size : Vector2i) -> Array[Array]:
	...
	#crawl and carve for num of steps defined	
...
func crawl(size: Vector2i) -> void:
	var updated_drunkards: Array[Vector2i] = []
	for drunkard: Vector2i in drunkards:
		...
		updated_drunkards.push_back(drunkard + walk_direction)
